...
public class Recycler4Adapter extends RecyclerView.Adapter {
    Context context;
    ArrayList<FragmentItem> items;

    public Recycler4Adapter(Context context, ArrayList<FragmentItem> items) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.recycler_item4, parent, false);
