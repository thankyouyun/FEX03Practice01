...
public class Tab1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("경제");


        recyclerView = findViewById(R.id.recycler);
        adapter = new Recycler1Adapter(this,items);
    ...
    void reedRSS() {
        ...
        try {
            URL url = new URL("http://rss.hankyung.com/new/news_economy.xml");
